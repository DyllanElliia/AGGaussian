...
if (args.resize):
  ...
  for file in files:
    ...
    # exit_code = os.system(magick_command + " mogrify -resize 50% " +
    #                       destination_file)
    # if exit_code != 0:
    ...
    shutil.copy2(source_file, destination_file)
    exit_code = os.system(magick_command + " mogrify -resize 25% " +
                          destination_file)
    if exit_code != 0:
    ...
    # shutil.copy2(source_file, destination_file)
    # exit_code = os.system(magick_command + " mogrify -resize 12.5% " +
    #                       destination_file)
    # if exit_code != 0:
